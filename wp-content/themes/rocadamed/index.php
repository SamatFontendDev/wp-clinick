...
<section style="background-image: url('<?php echo get_template_directory_uri() ?>/imgs/bg/XXL.jpg')" class="section hero">
                ...
                <div class="advantages__content">
                    ...
                    <div class="advantages__col advantages__col_center">
                        <div class="advantages__pic">
                            <img src="<?php echo get_template_directory_uri() ?>/imgs/pictures/reasons.jpg" alt="" class="advantages__img">
                        </div>
                    </div>
                </div>
        ...
        <section class="section advice">
            <div class="container">
                ...
                <div class="advice__text">
                    ...
                    <div class="advice__col">
                        <p><?php echo $redux_demo['doctor-recomendation']; ?></p>
                    </div>
                </div>
                <div class="doctor">
                    <div class="doctor__pic">
                        <img src="<?php echo get_template_directory_uri() ?>/imgs/pictures/gulshattafikovna.jpg" alt="" class="doctor__img">
                    </div>
        ...
        <section class="section section-form">
            <div class="container">
                <div class="form-wrap">
                    <form method="POST" class="form from-question">
                        <!-- <input name="type" type="hidden" value="Вопрос"> -->
                        <div class="form__title">Всегда рады ответить<br> на ваши вопросы</div>
                        <div class="form-row">
                            <input name="name" placeholder="Ваше имя" type="text" class="input">
                        </div>
                        <div class="form-row">
                            <input name="phone" placeholder="Контактный телефон" type="text" class="input input-tel">
                        </div>
                        <!-- <div class="form-row">
                            <textarea placeholder="Задайте вопрос" class="input textarea" name="text" id=""></textarea>
                        </div> -->
            ...
            <div class="container">
               ...
               <div class="specialists-content">
                ...
                <div class="specialists-slider">
                    <div style='background-image: url(<?php echo get_template_directory_uri() ?>/svg/icons/arrow.svg);' class="slider-button specialists-slider-prev"></div>
                    <ul class="specialists-slider__list">
                        <?php
                            ...
                            foreach($slider_docotrs as $post) {
                                ...
                                include(get_template_directory() . '/templates/content_doctor_slider.php');
                            }
        ...
        <section class="section news">
            <div class="container">
                <div class="news__top">
                    ...
                    <a href="/публикации" class="specialists-slider__btn-text specialists-slider__btn-text__absolute">Все публикации</a>
                </div>
