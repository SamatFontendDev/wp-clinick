            ...
            <div class="container">
                <div class="footer-content">
                    <div class="footer__col">
                        ...
                        <div class="footer-text">Процедура записи проста, понятна и не займёт много времени. Наш сотрудник свяжется с вами для уточнения деталей</div>
                    </div>
                    <div class="footer__col">
                        <div class="footer-row">
                ...
                <div class="footer-menu">
                    <ul class="footer-menu__list">
                        ...
                        <li class="footer-menu__item">
                            <a href="/uslugi" class="footer-menu__link">Услуги</a>
                        </li>
                        <li class="footer-menu__item">
                            <a href="/ceny" class="footer-menu__link">Цены</a>
                        </li>
                        <li class="footer-menu__item">
                        ...
                        <li class="footer-menu__item">
                            <a href="/o-nas" class="footer-menu__link">О нас</a>
                        </li>
                        <li class="footer-menu__item">
                            <a href="/kontakti" class="footer-menu__link">Контакты</a>
                        </li>
                        <li class="footer-menu__item">
                            <a href="/dokumenti" class="footer-menu__link">Документы</a>
                        </li>
                    </ul>
                </div>
            </div>
