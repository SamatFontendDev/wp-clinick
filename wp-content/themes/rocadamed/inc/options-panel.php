<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Разделы', 'redux-framework-demo' ),
        'page_title'           => __( 'Разделы', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'basic',
        'desc'             => __( 'Настройки для шаблона', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'Совет врача', 'redux-framework-demo' ),
                'subtitle' => __( 'Введите текст совета врача', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'implantacia-frist-text',
                'type'     => 'text',
                'title'    => __( 'Текст первого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
            ),
            array(
                'id'       => 'implantacia-second-title',
                'type'     => 'text',
            ...
            array(
                'id'       => 'implantacia-second-text',
                'type'     => 'text',
                'title'    => __( 'Текст второго блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
            ),
            array(
                'id'       => 'implantacia-works-title',
                'type'     => 'text',
                'title'    => __( 'Заголовок блока с клиническими случаямм', 'redux-framework-demo' ),
                'desc'     => __( 'Введите заголовок', 'redux-framework-demo' ),
                'default'  => ''
            ),
            array(
                'id'       => 'implantacia-works-text',
                'type'     => 'text',
            ...
            array(
                'id'       => 'implantacia-doctor-recomendation-text',
                'type'     => 'text',
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Виниры', 'redux-framework-demo' ),
        'id'               => 'basic-viniri-page',
        'subsection'       => true,
        'customizer_width' => '500px',
        'fields'           => array(
            array(
                'id'       => 'viniri-frist-text',
                'type'     => 'text',
                'title'    => __( 'Текст первого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Исправление прикуса', 'redux-framework-demo' ),
        'id'               => 'basic-ortodont-page',
        'subsection'       => true,
        'customizer_width' => '500px',
        'fields'           => array(
            array(
                'id'       => 'ortodont-frist-text',
                'type'     => 'text',
                'title'    => __( 'Текст первого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Лечение зубов', 'redux-framework-demo' ),
        'id'               => 'lechenie-zubov-basic--page',
        'subsection'       => true,
        'customizer_width' => '500px',
        'fields'           => array(
            array(
                'id'       => 'lechenie-zubov-frist-text',
                'type'     => 'text',
                'title'    => __( 'Текст первого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
           ...
           array(
            ...
            array(
                'id'       => 'lechenie-zubov-doctor-recomendation-text',
                'type'     => 'text',
                'title'    => __( 'Текст блока с советом врача', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Лечение десен', 'redux-framework-demo' ),
        'id'               => 'lechenie-desen-basic--page',
        'subsection'       => true,
        'customizer_width' => '500px',
        'fields'           => array(
            array(
                'id'       => 'lechenie-desen-frist-text',
                'type'     => 'text',
                'title'    => __( 'Текст первого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
           ...
           array(
                'id'       => 'lechenie-desen-second-title',
                'type'     => 'text',
                'title'    => __( 'Заголовок второго блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите заголовок', 'redux-framework-demo' ),
                'default'  => ''
            ...
            array(
                'id'       => 'lechenie-desen-doctor-recomendation-text',
                'type'     => 'text',
                'title'    => __( 'Текст блока с советом врача', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Отбеливание', 'redux-framework-demo' ),
        'id'               => 'otbelivanie-basic--page',
        'subsection'       => true,
        'customizer_width' => '500px',
        'fields'           => array(
            array(
                'id'       => 'otbelivanie-frist-text',
                'type'     => 'text',
                'title'    => __( 'Заголовок блока с клиническими случаямм', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
           ...
           array(
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'Заголовок блока четвертого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите заголовок', 'redux-framework-demo' ),
                'default'  => ''
            ),
            array(
                'id'       => 'otbelivanie-works-text',
                'type'     => 'text',
                'title'    => __( 'Текст четвертого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
            ),
            array(
                'id'       => 'otbelivanie-doctor-recomendation-title',
                'type'     => 'text',
                'title'    => __( 'Заголовок блока с советом врача', 'redux-framework-demo' ),
                'desc'     => __( 'Введите заголовок', 'redux-framework-demo' ),
                'default'  => ''
            ...
            array(
                'id'       => 'otbelivanie-doctor-recomendation-text',
                'type'     => 'text',
                'title'    => __( 'Текст блока с советом врача', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Детская стоматолгия', 'redux-framework-demo' ),
        'id'               => 'detskaya-basic--page',
        'subsection'       => true,
        'customizer_width' => '500px',
        'fields'           => array(
            array(
                'id'       => 'detskaya-frist-text',
                'type'     => 'text',
                'title'    => __( 'Текст первого блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст', 'redux-framework-demo' ),
                'default'  => ''
           ...
           array(
            ...
            array(
                'id'       => 'detskaya-doctor-recomendation-title',
                'type'     => 'text',
                'title'    => __( 'Заголовок третьего блока', 'redux-framework-demo' ),
                'desc'     => __( 'Введите заголовок', 'redux-framework-demo' ),
                'default'  => ''
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'about-title',
                'type'     => 'text',
                'title'    => __( 'Первый заголовок', 'redux-framework-demo' ),
                'desc'     => __( 'Введите заголовок', 'redux-framework-demo' ),
                'default'  => ''
            ),
           array(
